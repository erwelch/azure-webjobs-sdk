...
namespace Microsoft.Azure.WebJobs.Host.UnitTests.Loggers
{
    public class ApplicationInsightsLoggerTests : IDisposable
    {
        ...
        public ApplicationInsightsLoggerTests()
        {
            ...
            _functionInstance = new FunctionInstance(_invocationId, new Dictionary<string, string>(), null, null, null, ExecutionReason.AutomaticTrigger, null, null, descriptor);
        }
