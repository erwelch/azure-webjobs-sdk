    ...
    internal class WebJobsTelemetryInitializer : ITelemetryInitializer
    {
        ...
        public void Initialize(ITelemetry telemetry)
        {
            ...
            else if (request != null)
            {
                ...
                {
                    // tags is a list, we'll enumerate them
                    foreach (var tag in currentActivity.Tags)
                    {
                        switch (tag.Key)
                        {
                            ...
                            case LogConstants.DurationKey:
                                ...
                                break;
                            case LoggingConstants.W3CVersionTag:
                            case LoggingConstants.W3CTraceIdTag:
                            case LoggingConstants.W3CSpanIdTag:
                            case LoggingConstants.W3CSampledTag:
                            case LoggingConstants.W3CTraceStateTag:
                                break;
                            default:
