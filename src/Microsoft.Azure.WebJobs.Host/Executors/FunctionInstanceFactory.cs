...
namespace Microsoft.Azure.WebJobs.Host.Executors
{
    internal class FunctionInstanceFactory : IFunctionInstanceFactory
    {
        ...
        public IFunctionInstance Create(FunctionInstanceFactoryContext context)
        {
            ...
            return new FunctionInstance(context.Id, context.TriggerDetails, context.ParentId, context.Traceparent, context.Tracestate, context.ExecutionReason, bindingSource, _invoker, _descriptor);
        }
    }
}
